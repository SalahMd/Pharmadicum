...
class ItemInfo extends StatelessWidget {
  ...
  ItemInfo({super.key, required this.id});

  Uint8List tranImage(var image) {
                  ...
                  GetBuilder<ItemControllerImp>(
                    builder: (controller) => IconButton(
                      ...
                      onPressed: () {
                        ...
                        controller.info['is_favorite'] = !controller.info['is_favorite'];
                        controller.update();
                      },
                    ),
                  ),
                  ...
                  child: Column(children: [
                    ...
                    Expanded(
                      ...
                      child: Container(
                          ...
                          child: Image.memory(
                            tranImage(controller.info['image']),
                            fit: BoxFit.fill,
                          )),
                    ),
                    GetBuilder<ItemControllerImp>(
